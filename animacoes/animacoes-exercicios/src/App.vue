<template>
  <div id="app" class="container-fluid">
    ...
    <button variant="primary" @click="exibir2 = !exibir2">Alternar</button>
    <transition
      :css="false"
...
/* 
Os valores de *-enter-to e *-fade-leave são por padrão opacity: 1, portanto não precisam ser declarados
.fade-enter-to {
